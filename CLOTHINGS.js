...
async function fetchProduct(){
    ...
    .then(data => {
        console.log(data)
        let filteredProduct = data.filter(product => product.category == "clothing" || product.category == "fashion")
        // searchProduct = filteredProduct
        selectData = filteredProduct
...
async function fetchProduct2(){
    ...
    .then(data => {
        ...
        let filteredProduct = data.filter(product => product.category == "clothing" || product.category == "fashion")
        selectDataTwo = filteredProduct
        DisplayProducts2(filteredProduct)
    })
    .catch((err) => console.log("Error occur while fetching data", err))
}
